                ...
                <div className="container mx-auto text-center px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 opacity-90 p-6 rounded-lg shadow-md">
                            <h3 className="text-xl font-semibold text-white mb-3">Trí tuệ nhân tạo AI</h3>
                        ...
                        {/* Blockchain Card */}
                        <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 opacity-90 p-6 rounded-lg shadow-md">
                            <h3 className="text-xl font-semibold text-white mb-3">Công nghệ chuỗi khối</h3>
                            <ul className="space-y-2 text-white">
                        ...
                        {/* IoT Card */}
                        <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 opacity-90 p-6 rounded-lg shadow-md">
                            <h3 className="text-xl font-semibold text-white mb-3">Internet vạn vật IoT</h3>
                            <ul className="space-y-2 text-white">
