const Footer: React.FC = () => {
    return (
        <footer className="  bg-teal-900 text-white text-center  mt-8">    {/** cyan */}
            ...
            <div className="   mx-auto px-[40px] md:pl-[160px] pr-[50px]  grid grid-cols-1 md:grid-cols-3  gap-x-  ">
                ...
                <div className="text-left pt-[50px] md:py-[60px]   ">
                    
                    <h3 className="font-bold text-xl">VỀ CHÚNG TÔI </h3>
                    <p className="mt-2 text-lg "><strong>CÔNG TY TNHH CÔNG NGHỆ AME</strong></p>
                    <p className="mt-2"><strong>Địa chỉ:</strong> Số 8 Khu N4 DA nhà ở Xuân Đỉnh, Ngõ 40, Đường Xuân La, Phường Xuân Đỉnh, Hà Nội </p>
                    <p className="mt-2"><strong>Điện thoại:</strong> 0826611611</p>
                ...
                {/* Chính sách pháp lý  */}
                <div className="text-left pt-[40px] md:py-[60px]   pl-0 md:pl-[70px] "  >
            ...
            <p className="py-[30px] md:py-[20px]">AME TECHNOLOGY COMPANY LIMITED.</p>
        </footer>
    );
};
