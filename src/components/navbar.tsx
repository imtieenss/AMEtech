            ...
            >
                ...
                <ul
                    className={`flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8
                                ...
                                ${isOpen ? "backdrop-blur-lg bg-white/90 border border-white/10 md:backdrop-blur-none md:bg-transparent md:border-0" : "hidden md:flex"}
                                `}
                >
                    {MENU_LINKS.map((item) => (
                        <li key={item.id} >
                            <Link
                                ...
                                className={`menu-item text-[18px] font-bold transition cursor-pointer tracking-wide md:tracking-wider
                                    ${location.pathname === item.to
                                        ? "text-transparent bg-clip-text bg-gradient-to-r from-[#d40602] to-[#c51f02]"
